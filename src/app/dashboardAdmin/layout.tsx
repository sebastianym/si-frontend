      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="flex xl:px-32 items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] px-10 py-3">
          <div className="flex items-center gap-4 text-[#111418]">
            ...
            <h2 className="text-[#111418] text-lg font-semibold leading-tight tracking-[-0.015em]">
              Universidad Distrital{" "}
              <span className="max-lg:hidden">Francisco José de Caldas</span>
            </h2>
          </div>
          ...
          <button
            ...
            className="inline-flex relative z-10 items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
            <svg
          ...
          <aside
            ...
            } bg-gray-50 border-r border-gray/20 lg:hidden`}
            aria-label="Sidebar"
          >
